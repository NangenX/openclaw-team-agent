---
name: openclaw-setup
description: "Install OpenClaw 6-Agent AI dev team into your project. Provides product planning, orchestration, architecture, implementation, QA, and documentation agents with role prompts, workflow definitions, and handoff contracts."
version: 2.1.0
metadata:
  openclaw:
    requires:
...
为当前项目安装 OpenClaw 6-Agent AI 开发团队。
